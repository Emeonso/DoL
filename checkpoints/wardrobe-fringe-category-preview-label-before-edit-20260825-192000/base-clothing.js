...
function wardrobeHairCategories(layer) {
	return layer === "fringe" ? [
		{id: "straight", label: "Straight", preview: "straight", variables: ["default", "blunt locks", "curtain", "emo", "emo left", "emo right", "flat", "framed", "hime", "loose", "middlepart", "overgrown", "sectioned", "short air vents", "side-pinned", "straight", "trident"]},
		{id: "curly-textured", label: "Curly / Textured", preview: "ringlets", variables: ["aerial", "drill ringlets", "front braids", "loose antenna", "messy curls", "milkmaid", "princess wave", "ringlets", "sideswept braid", "sidecut"]},
